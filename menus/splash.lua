function make_splash()
    return {
        ...
        draw = function(current_frame)
            ...
            ui.print("pressione [start] para iniciar!", 290-1, 170, Palette.hex(0x552448))
            ui.print("pressione [start] para iniciar!", 290+1, 170, Palette.hex(0x552448))
            ui.print("pressione [start] para iniciar!", 290, 170+1, Palette.hex(0x552448))
            ui.print("pressione [start] para iniciar!", 290, 170-1, Palette.hex(0x552448))
            ui.print("pressione [start] para iniciar!", 290, 170, Palette.hex(0xFFFFFF))
        end
    }
end